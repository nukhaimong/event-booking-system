...
import { Menu, X, Calendar, User, LogIn, UserPlus, Ticket, CalendarPlus, LogOut, ChevronDown, Home } from 'lucide-react';
    ...
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            <span className="bg-blue-600 text-white px-3 py-1 rounded-lg">Jekono</span>
          </Link>

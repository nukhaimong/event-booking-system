...
export default function CreateEventForm() {
  ...
  const handleRemoveImage = () => {
    ...
    form.setFieldValue('photo', undefined as unknown as File);
          ...
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-8 py-10 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 max-w-md mx-auto">
                Fill in the details below to create a new event and start
                selling tickets
              </p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border border-blue-100">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600">
            <li className="flex items-start gap-2">
              ...
              Use a high-quality image to attract more attendees
            </li>
            <li className="flex items-start gap-2">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5"></span>
              Set a competitive price to increase ticket sales
            </li>
            <li className="flex items-start gap-2">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5"></span>
              Write a detailed description to inform attendees
            </li>
            <li className="flex items-start gap-2">
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-blue-500 mt-1.5"></span>
              Choose a date that doesn't conflict with major events
            </li>
          </ul>
        </div>
      </div>
